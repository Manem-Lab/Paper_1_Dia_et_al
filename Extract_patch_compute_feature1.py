...
def extract_patch (folder_path):
    ...
    for file in wsi_files:
        ...
        filenames_to_delete = df[df['score'] < 0.15]['filename'].apply(lambda x: x.replace(f"Patch1/{slide_name}/", ''))
        # Parcourir les noms de fichiers et supprimer les fichiers correspondants
        images_folder = os.path.join('/home/vad3/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/Patches/Patch1', f"{slide_name}")
...
extract_patch ('/home/vad3/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/WSIs/WSIs1')
...
patches_dir = '/home/vad3/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/Patches/Patch1'
